...
# Network measures
igraph::average.path.length(g2)
igraph::transitivity(g2)
# igraph::smallworldness(g2)

recs2 <- igraph::centr_degree(g2)
...
igraph::average.path.length(g3)
igraph::transitivity(g3)
# igraph::smallworldness(g3)

recs3 <- igraph::centr_degree(g3)
