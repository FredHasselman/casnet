...
To increase the resolution of the bins adjust the argument `scaleResolution` and/or the values of `scaleMin` and `scaleMax`
...
Below the argument `scaleMin`, which defaults to `4`, is used to adjust the fit range.
