...
#'
dc_win <- function(df, win=0, scale_min, scale_max, doPlot = FALSE, doPlotF = FALSE, doPlotD = FALSE, returnFandD = FALSE, useVarNames = TRUE, colOrder = TRUE, useTimeVector = NA, timeStamp = "31-01-1999", markID = NA, NAdates = 1:(win-1), trimFirstWin = TRUE){
  ...
  g <- NULL
  if(doPlot){
    g <- plotDC_res(df_win = df_win, win = win, useVarNames = useVarNames, colOrder = colOrder, useTimeVector = useTimeVector, timeStamp = timeStamp, markID = markID, NAdates = NAdates, doPlot = doPlot)
  }
...
#'
#'
dc_ccp = function(df_win , alpha_item = 0.05, alpha_time = 0.05, doPlot = FALSE, useVarNames = TRUE, colOrder = TRUE, useTimeVector = NA, timeStamp = "31-01-1999", markID = NA, NAdates = 1:(win-1), trimFirstWin = TRUE){
  ...
  if(doPlot){
    ...
    g <- plotDC_ccp(df_ccp = df_ccp, win = win, useVarNames = useVarNames, colOrder = colOrder, useTimeVector = useTimeVector, timeStamp = as.character(timeStamp), markID = markID, doPlot = doPlot, NAdates = NAdates, trimFirstWin = trimFirstWin)
